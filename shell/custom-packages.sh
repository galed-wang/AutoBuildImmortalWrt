...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-upnp miniupnpd-nftables"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES vlmcsd luci-app-vlmcsd"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES shadowsocks-rust-sslocal shadowsocks-rust-ssservice shadowsocks-libev-ss-redir shadowsocksr-libev-ssr-redir xray-core hysteria naiveproxy trojan-plus v2ray-plugin"
